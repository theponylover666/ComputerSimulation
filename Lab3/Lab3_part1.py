...
def SCWUQ():
    ...
    Single_channel.With_Unlimited_Queue(lambda_, T_obs)
...
def MCWDOS():
    ...
    lambda_ = safe_input("Интенсивность входящего потока: ", float)
    mu = safe_input("Интенсивность обслуживания одним каналом: ", float)
    Multi_channel.With_Denial_Of_Service(n, lambda_, mu)
...
def MCWLQ():
    ...
    lambda_ = safe_input("Интенсивность входящего потока: ", float)
    mu = safe_input("Интенсивность обслуживания одним каналом: ", float)
    Multi_channel.With_Limited_Queue(n, m, lambda_, mu)
...
def MCWUQ():
    ...
    lambda_ = safe_input("Интенсивность входящего потока: ", float)
    mu = safe_input("Интенсивность обслуживания одним каналом: ", float)
    Multi_channel.With_Unlimited_Queue(n, lambda_, mu)
        ...
        case 2:
            while (number > 0):
                print(
                    ...
                    + "6. МНОГОКАНАЛЬНЫЕ СМО С НЕОГРАНИЧЕННОЙ ОЧЕРЕДЬЮ " + "0. Выйти")
                number = safe_input("", int)
                print("\n" * 5)
                match number:
                    case 1:
